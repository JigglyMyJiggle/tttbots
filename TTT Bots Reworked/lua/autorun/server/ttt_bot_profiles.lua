...
bot_profiles = {
    ...
    {name = "Mildly Menacing Flower Pot", accuracy = 0.95, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "Traitor", accuracy = 0.65, personality = 1},
    {name = "loser", accuracy = 0.8, personality = 1},
    {name = "Nobody", accuracy = 0.55, personality = 2},
    {name = "Beep Boop", accuracy = 0.8, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "Babies", accuracy = 0.85, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "god", accuracy = 0.9, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "1v1 me m8", accuracy = 0.95, personality = 1/*was a personality of 0 prior to edit*/},
    {name = "Dweeb Power", accuracy = 0.55, personality = 3},
    {name = "Mr. Rusty booty", accuracy = 0.9, personality = 1/*was a personality of 0 prior to edit*/},
    {name = "Noxious Tank", accuracy = 0.85, personality = 1},
    {name = "Ewitt69", accuracy = 0.9, personality = 1},
    {name = "Hike Munt", accuracy = 0.7, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "Unstable Finger", accuracy = 0.55, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "Biglong Shlongdong", accuracy = 0.6, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "Webber", accuracy = 1, personality = 1/*was a personality of 0 prior to edit*/},
    {name = "Wilson", accuracy = 0.9, personality = 2},
    {name = "Willow", accuracy = 0.7, personality = 1},
    {name = "your mom", accuracy = 0.55, personality = 1/*was a personality of 0 prior to edit*/},
    {name = "bigbootygirl420", accuracy = 0.55, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "CRITRAWKETS", accuracy = 0.8, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "Pomme", accuracy = 0.7, personality = 1/*was a personality of 0 prior to edit*/},
    {name = "Terre", accuracy = 0.95, personality = 1},
    {name = "Vintage Sandvich", accuracy = 0.9, personality = 2},
    {name = "Pooty", accuracy = 0.7, personality = 1/*was a personality of 0 prior to edit*/},
    ...
    {name = "John Cena", accuracy = 0.95, personality = 1/*was a personality of 0 prior to edit*/},
